...
namespace AllByMyshelf.Api.Migrations
{
    ...
    [Migration("20260327110809_RenameAndBaseEntity")]
    partial class RenameAndBaseEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AllByMyshelf.Api.Models.Entities.BoardGame", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("Designers")
                        .IsRequired()
                        .HasColumnType("text[]")
            ...
            modelBuilder.Entity("AllByMyshelf.Api.Models.Entities.Release", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("TrackArtists")
                        .IsRequired()
                        .HasColumnType("text[]")
